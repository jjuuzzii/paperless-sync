...
_EN: dict[str, str] = {
    ...
    "abweichenden Wirtschaftsjahr mit Startmonat Juli.":
        "Determines which 12 months the yearly export bundles together - e.g. July to June for a "
        "fiscal year starting in July.",
    "Kalenderjahr verwenden (Januar-Dezember)": "Use calendar year (January-December)",
    "Startmonat des Wirtschaftsjahrs": "Fiscal year start month",
    "Januar": "January",
    "Februar": "February",
    "März": "March",
    "April": "April",
